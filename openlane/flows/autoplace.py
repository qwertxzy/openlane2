...
@Flow.factory.register()
class HierRTLMP(SequentialFlow):
  """
  The classic openlane 1.0 flow with the Hier-RTLMP for macro placement.
  """
  Steps = [
      Verilator.Lint,
      Checker.LintTimingConstructs,
...
@Flow.factory.register()
class LegalizeMP(SequentialFlow):
  """
  The classic openlane 1.0 flow with a custom macro legalizer step.
  """
  Steps = [
      Verilator.Lint,
      Checker.LintTimingConstructs,
      ...
      OpenROAD.GlobalPlacement,
      # Legalize macro placement from this
      OpenROAD.LegalizeMacroPlacement,
      OpenROAD.CutRows,
      OpenROAD.TapEndcapInsertion,
      Odb.AddPDNObstructions,
      OpenROAD.GeneratePDN,
